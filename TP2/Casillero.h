...
public:
   ...
   * Post: asigna el casillero recibido como adyacente en la posicion recibida respecto del
  ...
  /*
   * pre : que exista la clase casillero previamente, recibe un tipo de dato Casillero.
  ...
  /*
   * pre: que exista la clase casillero previamente, Recibe un tipo de dato Ficha.
  ...
  /*
   * Pre: Exista una instancia de la clase casillero,recibe una casillero valido.
